...
public class TwoDragonsFanRenderer extends EntityRenderer<TwoDragonsFanEntity> {

    public TwoDragonsFanRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void render(TwoDragonsFanEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    private void renderTexture(TwoDragonsFanEntity entity, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(TwoDragonsFanEntity entity) {
        return entity.isFire() ? FIRE_TEXTURE : ICE_TEXTURE;
    }
}
